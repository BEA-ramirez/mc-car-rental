...
export default function LoginPage() {
  return (
    <div className="relative flex flex-col min-h-[100dvh] bg-[#050B10] text-white selection:bg-[#64c5c3] selection:text-black font-sans overflow-hidden">
      ...
      {/* Center: The Form - Flex-1 ensures perfect vertical/horizontal centering */}
      <main className="flex-1 flex items-center justify-center w-full px-4 sm:px-6 z-10">
        <motion.div
          initial={{ opacity: 0, scale: 0.95, y: 20 }}
          animate={{ opacity: 1, scale: 1, y: 0 }}
          transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1], delay: 0.1 }}
          className="w-full max-w-[22rem] sm:max-w-sm md:max-w-md"
        >
          <LoginForm />
        </motion.div>
      </main>
