...
export default function AdminCarDetailsPage() {
  ...
  const mapDataForForm = (details: any) => {
    ...
    return {
      ...
      rental_rate_per_12h: details.rental_rate_per_12h || 0,
      default_buffer_hours: details.default_buffer_hours || 12,
  ...
  return (
    <div className={isDarkMode ? "dark" : ""}>
      <div className="h-screen bg-background text-foreground font-sans flex flex-col transition-colors duration-300">
        {/* --- COMPACT TOP HEADER --- */}
        <header className="px-4 py-3 sm:px-6 shrink-0 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-transparent border-b border-border/50">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:px-6 custom-scrollbar">
          <div className="max-w-[1600px] mx-auto flex flex-col gap-4 pb-8">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
              {/* LEFT COLUMN: Partner Info & Utilization */}
              <div className="xl:col-span-3 flex flex-col gap-4">
                ...
                <div className="bg-card border border-border rounded-xl p-4 shadow-sm shrink-0">
                  ...
                  {/* UPDATED: Stacked Financial Info */}
                  <div className="flex flex-col gap-2 mt-2 text-[10px]">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <strong className="text-primary">
                        ₱
                        {(carDetails.rental_rate_per_12h || 0).toLocaleString()}
                      </strong>
                    </div>
                  </div>
              ...
              {/* RIGHT COLUMN: Image, Specs & Features */}
              <div className="xl:col-span-9 flex flex-col">
                <div className="bg-card border border-border rounded-xl p-3 sm:p-4 shadow-sm flex flex-col lg:flex-row gap-4 h-full">
                  {/* Main Interactive Image Container - UPDATED WITH FIXED HEIGHT */}
                  <div className="w-full lg:w-1/2 h-64 lg:h-80 shrink-0 rounded-lg bg-muted overflow-hidden relative border border-border flex items-center justify-center">
                    {activeImage ? (
                      <Image
                        src={activeImage}
                        alt="Car"
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col">
                    <div className="grid grid-cols-2 gap-2 flex-1">
                      {[
                        ...
                        <div
                          key={spec.id}
                          className="border border-border rounded p-2 flex flex-col justify-between bg-secondary/50 hover:border-primary/50 transition-colors group cursor-default relative min-h-[60px]"
                        >
            ...
            {/* FULL WIDTH BOTTOM ROW: Bookings Grid */}
            <div className="bg-card border border-border rounded-xl p-4 shadow-sm w-full min-h-[300px] flex flex-col">
                ...
                <div className="flex gap-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-6 h-7 w-40 text-[10px] font-medium bg-secondary border border-border rounded focus:outline-none focus:ring-1 focus:ring-primary text-foreground"
                    />
                  </div>
              ...
              {/* Upgraded grid to display 4 wide on extra-large screens */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 flex-1">
                ...
                carDetails.recent_bookings.length > 0 ? (
                  ...
                  <div className="col-span-full flex flex-col items-center justify-center h-48 text-muted-foreground bg-secondary/30 rounded-lg border border-dashed border-border">
