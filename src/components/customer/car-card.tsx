...
interface CarCardProps {
  car: any; // We'll type this properly when we connect the backend
  onViewDetails: () => void;
}
...
export default function CarCard({ car, onViewDetails }: CarCardProps) {
  return (
    <div className="group bg-white rounded-3xl border border-slate-200 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col">
      {/* Image Container - Reduced height to h-44 for compactness */}
      ...
      {/* Content Container - Reduced padding to p-5 */}
      <div className="p-5 flex flex-col flex-1">
        ...
        {/* Specs Row - Smaller, denser pills with slightly darker background for contrast */}
        ...
        {/* Footer: Price & Action - High contrast price and button */}
