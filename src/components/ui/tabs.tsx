...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-foreground/10 text-muted-foreground inline-flex h-9 w-full items-center justify-start rounded-lg p-[3px]",
        className,
      )}
      {...props}
    />
